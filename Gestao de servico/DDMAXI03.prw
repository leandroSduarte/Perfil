...
ฑฑบPrograma  | DDMAXI03 บAutor  ณ Gabriel Verํssimo  บ Data ณ  27/06/19   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Rotina de Cadastro de Execu็ใo			                  บฑฑ
...
User Function DDMAXI03()
	...
	oBrowse:SetDescription("Cadastro de Execu็ใo")
...
Static Function MenuDef()
	...
	ADD OPTION aRotina TITLE "Integra็ใo Maxview"			ACTION "u_DDMAXI3X" 	  	OPERATION 9 	ACCESS 0
	ADD OPTION aRotina TITLE "Integra็ใo Maxview Todos" 	ACTION "u_DDMAXI3Z" 		OPERATION 10 	ACCESS 0
...
Static Function ViewDef()
	...
	oView:EnableTitleView('Formulario' , 'Cadastro de Execu็ใo' )	
...
Static Function ModelDef()
	Local oModel
	Local oStr1:= FWFormStruct( 1, 'SZB', /*bAvalCampo*/,/*lViewUsado*/ ) // Constru็ใo de uma estrutura de dados
	...
	oModel:SetDescription('Cadastro de Execu็ใo')
...
Static Function MVC001V( oModel )
	...
	nOpc    := oModel:GetOperation() //nOpc ้ variแvel private - Gabriel
...
ฑฑบPrograma  | DDMAXI3X บAutor  ณ Gabriel Verํssimo  บ Data ณ  27/06/19   บฑฑ
...
User Function DDMAXI3X(lMensagem, lDel)
	...
	If !Empty(c_Errors)
		Conout("Nใo foi possํvel enviar a Execu็ใo "+AllTrim(SZB->ZB_COD)+" a Max View. Mensagem do erro: "+AllTrim(c_Errors))
		if lMensagem
			MsgStop("Nใo foi possํvel enviar a Execu็ใo "+AllTrim(SZB->ZB_COD)+" a Max View. Mensagem do erro: "+AllTrim(c_Errors))
		endif
		Return(Nil)
	EndIf
	...
	Conout("Execu็ใo "+AllTrim(SZB->ZB_COD)+" enviado a Max View. "+Iif(!Empty(c_IDMax),"ID Max "+AllTrim(c_IDMax),""))
	if lMensagem
		MsgInfo("Execu็ใo "+AllTrim(SZB->ZB_COD)+" enviado a Max View. "+Iif(!Empty(c_IDMax),"ID Max "+AllTrim(c_IDMax),""))
	endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  | DDMAXI3Z   บAutor  ณ Gabriel Verํssimo  บ Data ณ  27/06/19 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออสออออออฯอออออออออออออนฑฑ

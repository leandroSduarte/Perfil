...
ฑฑบDesc.     ณ Rotina de Cadastro de Grupo				                  บฑฑ
...
//	ADD OPTION aRotina TITLE "Imprimir" 					ACTION "VIEWDEF.DDMAXI04" 	OPERATION 8 	ACCESS 0
	...
	ADD OPTION aRotina TITLE "Integra็ใo Maxview"			ACTION "u_DDMAXI4X" 	  	OPERATION 9 	ACCESS 0
	ADD OPTION aRotina TITLE "Integra็ใo Maxview Todos" 	ACTION "u_DDMAXI4Z" 		OPERATION 10 	ACCESS 0
...
Static Function ViewDef()
	...
	// Define qual o Modelo de dados serแ utiliZCdo
...
Static Function ModelDef()
	Local oModel
	Local oStr1:= FWFormStruct( 1, 'SZC', /*bAvalCampo*/,/*lViewUsado*/ ) // Constru็ใo de uma estrutura de dados
...
ฑฑบPrograma  | DDMAXI4X   บAutor  ณ Gabriel Verํssimo  บ Data ณ  27/06/19  บฑฑ
...
User Function DDMAXI4X(lMensagem, lDel)
	...
	If !Empty(c_Errors)
		Conout("Nใo foi possํvel enviar o Grupo "+AllTrim(SZC->ZC_COD)+" a Max View. Mensagem do erro: "+AllTrim(c_Errors))
		if lMensagem
			MsgStop("Nใo foi possํvel enviar o Grupo "+AllTrim(SZC->ZC_COD)+" a Max View. Mensagem do erro: "+AllTrim(c_Errors))
		endif
		Return(Nil)
	EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  | DDMAXI4Z   บAutor  ณ Gabriel Verํssimo  บ Data ณ  27/06/19 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  | MVC004     บAutor  ณ Gabriel Verํssimo  บ Data ณ  27/06/19 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออสออออออฯอออออออออออออนฑฑ

...
/*/
//--------------------------------------------------------------------
User Function UPDSCK( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDSCK" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDSCK" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDSCK" ) ) ) ;

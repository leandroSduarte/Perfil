...
/*/
//--------------------------------------------------------------------
User Function UPDAB5( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDAB5" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDAB5" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'Pertence("FLRXSX") '													, ; //X3_VLDUSER
	'F=Cons.Final;L=Prod.Rural;R=Revendedor;S=Solidario;X=Exportacao/Importacao'			, ; //X3_CBOX
	'F=Cons.Final;L=Prod.Rural;R=Revendedor;S=Solidario;X=Exportacao/Importacao'	    	, ; //X3_CBOXSPA
	'F=Cons.Final;L=Prod.Rural;R=Revendedor;S=Solidario;X=Exportacao/Importacao'			, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	'Aliq. IPI %'															, ; //X3_TITSPA
	'Aliq. IPI %'															, ; //X3_TITENG
	'Aliquota Ipi'															, ; //X3_DESCRIC
	'Aliquota Ipi'															, ; //X3_DESCSPA
	'Aliquota Ipi'															, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Alq. ICM %'															, ; //X3_TITSPA
	'Alq. ICM %'															, ; //X3_TITENG
	'Aliquota ICM'															, ; //X3_DESCRIC
	'Aliquota ICM'															, ; //X3_DESCSPA
	'Aliquota ICM'															, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Aliq. COF %'															, ; //X3_TITSPA
	'Aliq. COF %'															, ; //X3_TITENG
	'Aliquota COFINS'														, ; //X3_DESCRIC
	'Aliquota COFINS'														, ; //X3_DESCSPA
	'Aliquota COFINS'														, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Aliq. ST %'															, ; //X3_TITSPA
	'Aliq. ST %'															, ; //X3_TITENG
	'Aliquota ST'															, ; //X3_DESCRIC
	'Aliquota ST'															, ; //X3_DESCSPA
	'Aliquota ST'															, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Valor ICM'																, ; //X3_TITSPA
	'Valor ICM'																, ; //X3_TITENG
	'Valor ICM'																, ; //X3_DESCRIC
	'Valor ICM'																, ; //X3_DESCSPA
	'Valor ICM'																, ; //X3_DESCENG
	'@E 9,999,999,999,999.99'												, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Valor Liq.'															, ; //X3_TITSPA
	'Valor Liq.'															, ; //X3_TITENG
	'Valor Liquido Impostos'												, ; //X3_DESCRIC
	'Valor Liquido Impostos'												, ; //X3_DESCSPA
	'Valor Liquido Impostos'												, ; //X3_DESCENG
	'@E 9,999,999,999,999.99'												, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX9, { ;
	...
	'001'																	, ; //X9_IDENT
	'SC6'																	, ; //X9_CDOM
	'AB5_NUMORC+AB5_ITEM'													, ; //X9_EXPDOM
	'C6_NUMORC'																, ; //X9_EXPCDOM
	'S'																		, ; //X9_PROPRI
	'1'																		, ; //X9_LIGDOM
	'1'																		, ; //X9_LIGCDOM
	''																		, ; //X9_CONDSQL
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDAB5" ) ) ) ;

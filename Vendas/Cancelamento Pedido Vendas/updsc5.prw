...
aAdd( aSX3, { ;
	...
	15																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'User Cancel'															, ; //X3_TITULO
	'User Cancel'															, ; //X3_TITSPA
	'User Cancel'															, ; //X3_TITENG
	'Usuario de cancelamento'												, ; //X3_DESCRIC
	'Usuario de cancelamento'												, ; //X3_DESCSPA
	'Usuario de cancelamento'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	50																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Motivo Canc.'															, ; //X3_TITULO
	'Motivo Canc.'															, ; //X3_TITSPA
	'Motivo Canc.'															, ; //X3_TITENG
	'Motivo de cancelamento'												, ; //X3_DESCRIC
	'Motivo de cancelamento'												, ; //X3_DESCSPA
	'Motivo de cancelamento'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt. Cancela'															, ; //X3_TITULO
	'Dt. Cancela'															, ; //X3_TITSPA
	'Dt. Cancela'															, ; //X3_TITENG
	'Data de cancelamento'													, ; //X3_DESCRIC
	'Data de cancelamento'													, ; //X3_DESCSPA
	'Data de cancelamento'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Hora de Cancelamento'													, ; //X3_DESCSPA
	'Hora de Cancelamento'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;

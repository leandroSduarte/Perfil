...
/*/
//--------------------------------------------------------------------
User Function UPDAPT( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDAPT" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDAPT" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'CADASTRO DE OPERADORES'												, ; //X2_NOME
	'CADASTRO DE OPERADORES'												, ; //X2_NOMESPA
	'CADASTRO DE OPERADORES'												, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'APONTAMENTO ESPECIFICO'												, ; //X2_NOME
	'APONTAMENTO ESPECIFICO'												, ; //X2_NOMESPA
	'APONTAMENTO ESPECIFICO'												, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	'GETSX8NUM("SZ2","Z2_CODIGO")'											, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	'Nome'																	, ; //X3_TITSPA
	'Nome'																	, ; //X3_TITENG
	'Nome do Operador'														, ; //X3_DESCRIC
	'Nome do Operador'														, ; //X3_DESCSPA
	'Nome do Operador'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt.Inicial'															, ; //X3_TITULO
	'Dt.Inicial'															, ; //X3_TITSPA
	'Dt.Inicial'															, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	5																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Hora Final'															, ; //X3_TITULO
	'Hora Final'															, ; //X3_TITSPA
	'Hora Final'															, ; //X3_TITENG
	'Hora Final'															, ; //X3_DESCRIC
	'Hora Final'															, ; //X3_DESCSPA
	'Hora Final'															, ; //X3_DESCENG
	'99:99'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	11																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Qtd. Perdida'															, ; //X3_TITULO
	'Qtd. Perdida'															, ; //X3_TITSPA
	'Qtd. Perdida'															, ; //X3_TITENG
	'Quantidade Perdida'													, ; //X3_DESCRIC
	'Quantidade Perdida'													, ; //X3_DESCSPA
	'Quantidade Perdida'													, ; //X3_DESCENG
	'@E 99,999,999.99'														, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Gera SH6'																, ; //X3_TITSPA
	'Gera SH6'																, ; //X3_TITENG
	'Controle SH6'															, ; //X3_DESCRIC
	'Controle SH6'															, ; //X3_DESCSPA
	'Controle SH6'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SZ3'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'Z3_FILIAL+Z3_OP+Z3_PRODUTO+Z3_OPERAC'									, ; //CHAVE
	'O.P.+Produto+Operacao'													, ; //DESCRICAO
	'O.P.+Produto+Operacao'													, ; //DESCSPA
	'O.P.+Produto+Operacao'													, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'CONSULTA OPERADORES'													, ; //XB_DESCRI
	'CONSULTA OPERADORES'													, ; //XB_DESCSPA
	'CONSULTA OPERADORES'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZ2'																	} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDAPT" ) ) ) ;
